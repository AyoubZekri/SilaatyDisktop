...
import 'package:silaaty_desktop/data/datasource/Remote/Auth/logen_data.dart';
    ...
    if (formData!.validate()) {
      ...
      if (statusrequest == Statusrequest.success) {
        if (response["status"] == 1) {
          ...
          myServices.sharedPreferences!.setString(
            "phone",
            response["data"]["user"]["user"]["phone_number"],
          );
          myServices.sharedPreferences!.setString(
            "family_name",
            response["data"]["user"]["user"]["family_name"],
          );
          myServices.sharedPreferences!.setInt(
            "user_notify_status",
          ...
          if (response["data"]["user"]["user"]["logo_stor"] != null) {
            myServices.sharedPreferences!.setString(
              "logo_stor",
              response["data"]["user"]["user"]["logo_stor"],
            );
          }
