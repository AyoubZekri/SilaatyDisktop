...
class PaymentController extends GetxController {
  ...
  void onInit() {
    ...
    if (selectedCustomer == "virtualCustomer".tr) {
      paymentController =
          TextEditingController(text: finalAmount.toStringAsFixed(2).replaceAll(RegExp(r'0*$'), '').replaceAll(RegExp(r'\.$'), ''));
    } else {
      paymentController = TextEditingController(text: "0");
    }
  }
  ...
  void recalculateFinalAmount() {
    ...
    if (selectedCustomer == "virtualCustomer".tr) {
      paymentController.text = finalAmount.toStringAsFixed(2).replaceAll(RegExp(r'0*$'), '').replaceAll(RegExp(r'\.$'), '');
    }
