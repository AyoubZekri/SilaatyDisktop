  ...
  Widget build(BuildContext context) {
    ...
    switch (statusrequest) {
      ...
      case Statusrequest.none:
        content = Center(
          child: Padding(
            padding: const EdgeInsets.only(top: 100.0), // إزاحة لأسفل
            child: SizedBox(
              width: 50,
              height: 50,
        ...
        return SingleChildScrollView(
          ...
          child: ConstrainedBox(
            constraints: BoxConstraints(
              minHeight: constraints.hasBoundedHeight ? constraints.maxHeight : 0.0, // يشغل كل مساحة الشاشة إذا كان محدداً
            ),
            child: Center(
              child: Padding(
                padding: const EdgeInsets.only(top: 100.0), // إزاحة لأسفل
