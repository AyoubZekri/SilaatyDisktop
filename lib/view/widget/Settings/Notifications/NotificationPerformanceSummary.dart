...
class NotificationPerformanceSummary extends StatelessWidget {
  ...
  const NotificationPerformanceSummary({super.key, required this.isDark});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: AppColor.primaryPurple.withOpacity(0.3), blurRadius: 20, offset: const Offset(0, 10))],
      ),
      child: Row(
