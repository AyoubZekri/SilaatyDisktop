...
class CustemTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final subtitleColor = AppColor.textSecondary;
    final borderColor = isDark ? AppColor.surfaceDark : Colors.grey.shade300;
    final inputFillColor = isDark ? AppColor.surfaceDark : AppColor.white;
