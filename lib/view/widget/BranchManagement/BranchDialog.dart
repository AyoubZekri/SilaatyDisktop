...
class BranchDialog extends StatefulWidget {
  ...
  final int? sellerId;
  const BranchDialog({super.key, required this.isDark, required this.controller, this.sellerId});
        ...
        child: Form(
          ...
          children: [
            ...
            _buildTextField(
              ...
              validator: (val) => validInput(val!, 50, 3, 'username'),
            ),
            ...
            _buildTextField(
              ...
              validator: (val) {
                if (widget.sellerId == null && (val == null || val.isEmpty)) {
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          height: 50,
          decoration: BoxDecoration(
            color: widget.isDark ? AppColor.primaryPurple.withOpacity(0.2) : const Color(0xFFEDE9FE),
            borderRadius: BorderRadius.circular(12),
          ),
          child: Icon(Icons.add_business_outlined, color: AppColor.primaryPurple, size: 28),
        ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                widget.sellerId == null ? "add_new_seller".tr : "edit_seller".tr,
                style: TextStyle(
                  fontSize: 24,
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 14,
                  color: widget.isDark ? AppColor.textSecondary : Colors.grey.shade500,
                  fontFamily: 'Cairo',
                ),
              ),
            ],
