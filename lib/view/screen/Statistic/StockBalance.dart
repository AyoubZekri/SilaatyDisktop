...
import '../../widget/Statistic/ReportsStockBalanceSummary.dart';
import '../../widget/Statistic/ReportsStockBalanceTable.dart';
...
class StockBalance extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(Stockbalancecontroller());
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                   Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () => statController.showFilterDialog(context, statController.gotoStockBalance),
                   ...
                   ReportsStockBalanceSummary(isDark: isDark),
                   const SizedBox(height: 48),
                   ReportsStockBalanceTable(isDark: isDark),
